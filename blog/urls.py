...
urlpatterns = [
    ...
    path('post/<int:pk>/', PostDetailView.as_view(), name='post-detail'), # "if we are passing the class based views we cannot pas sthe class name, we user classname.as_view()"
